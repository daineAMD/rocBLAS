...
extern "C" rocblas_status rocblas_gemm_batched_ex_offset(rocblas_handle    handle,
                                                  rocblas_operation trans_a,
                                                  rocblas_operation trans_b,
                                                  rocblas_int       m,
                                                  rocblas_int       n,
...
#define EX_TYPECASTING_PARM                                                 \
    handle, trans_a, trans_b, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc, \
        d, ldd, batch_count, offset_a, offset_b, offset_c, offset_d
...
extern "C" rocblas_status rocblas_gemm_batched_ex(rocblas_handle handle,
                                                  ...
                                                  uint32_t          flags)
{
    return rocblas_gemm_batched_ex_offset(handle, trans_a, trans_b, m, n, k, alpha, a, a_type, lda,
                                   b, b_type, ldb, beta, c, c_type, ldc, d, d_type, ldd,
                                   batch_count, compute_type, algo, 0, 0, 0, 0, solution_index, flags);
}