...
rocblas_status gemm_ex_chunking(rocblas_handle    handle,
                                ...
                                unsigned int      ldd,
                                unsigned int      batch_count,
                                unsigned int      offsetAin = 0,
                                unsigned int      offsetBin = 0,
                                unsigned int      offsetCin = 0,
                                unsigned int      offsetDin = 0)
{
    unsigned int int_limit    = std::numeric_limits<int>::max() / sizeof(To);
    unsigned int m_chunk_size = m;
    unsigned int n_chunk_size = n;
...
rocblas_status gemm_ex_typecasting(rocblas_handle    handle,
                                   ...
                                   rocblas_int       ldd,
                                   rocblas_int       batch_count,
                                   rocblas_int       offsetAin = 0,
                                   rocblas_int       offsetBin = 0,
                                   rocblas_int       offsetCin = 0,
                                   rocblas_int       offsetDin = 0)
{
    Tc h_alpha;
    Tc h_beta;
